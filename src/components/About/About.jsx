          ...
          <Row className="align-items-center mb-4">
            <Col lg={5} className="mb-4 mb-lg-0">
              <div className="about-image-wrapper" data-aos="fade-right">
                <div className="about-image-container grid-container" style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '20px', padding: '20px', position: 'relative', left: '-80px' }}>
                  ...
                  {selectedMember && (
                    <>
                      ...
                      >
                        ...
                        <h4 style={{ marginBottom: '10px', color: '#005F73', fontSize: '16px' }}>{selectedMember.name}</h4>
                        <div style={{
                          width: '150px',
                          height: '150px',
          ...
          <div className="gallery-section mt-5 text-center">
            ...
            <div className="text-center mt-4 mb-5">
                <button 
                  ...
                  style={{
                    cursor: 'pointer',
                    background: showAllImages ? 'transparent' : '#005F73',
                    color: showAllImages ? '#005F73' : 'white',
                    border: showAllImages ? '2px solid #005F73' : 'none',
                    padding: '15px 40px',
                    borderRadius: '30px',
                    fontSize: '18px',
                    fontWeight: '600',
                    transition: 'all 0.3s ease',
                    boxShadow: showAllImages ? 'none' : '0 4px 15px rgba(0,0,0,0.2)',
                    outline: 'none',
                    position: 'relative',
                    overflow: 'hidden',
                    display: 'inline-flex',
                  ...
                  onMouseOver={(e) => {
                    if (showAllImages) {
                      ...
                      e.target.style.background = '#004957';
                    }
                  ...
                  onMouseOut={(e) => {
                    ...
                    e.target.style.boxShadow = showAllImages ? 'none' : '0 4px 15px rgba(0,0,0,0.2)';
                  }}
                >
                  {showAllImages ? (
                    <>
